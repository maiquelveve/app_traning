...
describe("@integration", () => {
  describe("MODALITIES CONTROLLER - Get All Modalities TRAINING", () => {
    ...
    it("it should be possible to get all modalities training by token of ROOT valid",  async () => {      
    ...
    it("it should be possible to get all modalities training by token of TRAINER valid",  async () => {      
    ...
    it("it not should be possible to get all modalities training by token NOT ROOT or TRAINER valid",  async () => {      
    ...
    it("it not should be possible to get all modalities training by token invalid",  async () => {      
