...
describe("@integration", () => {
  describe("MODALITIES CONTROLLER - Get All Modalities CLASS", () => {
    ...
    it("it should be possible to get all modalities class by token of ROOT valid",  async () => {      
    ...
    it("it should be possible to get all modalities class by token of TRAINER valid",  async () => {      
    ...
    it("it not should be possible to get all modalities class by token NOT ROOT or TRAINER valid",  async () => {      
    ...
    it("it not should be possible to get all modalities class by token invalid",  async () => {      
